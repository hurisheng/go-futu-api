...
var file_Qot_UpdateOrderDetail_proto_goTypes = []any{
...
func file_Qot_UpdateOrderDetail_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_Qot_UpdateOrderDetail_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*S2C); i {
			case 0:
				return &v.state
			case 1:
		...
		file_Qot_UpdateOrderDetail_proto_msgTypes[1].Exporter = func(v any, i int) any {
