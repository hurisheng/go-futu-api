...
type OptionItem struct {
	...
	Call *Qot_Common.SecurityStaticInfo `protobuf:"bytes,1,opt,name=call" json:"call,omitempty"` //看涨,不一定有该字段,由请求条件决定
	Put  *Qot_Common.SecurityStaticInfo `protobuf:"bytes,2,opt,name=put" json:"put,omitempty"`   //看跌,不一定有该字段,由请求条件决定
}
...
var file_Qot_GetOptionChain_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x5f, 0x47, 0x65, 0x74, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x68, 0x61, 0x69,
	0x6e,
}
